<div class="bg-black px-12">
    ...
    <div class="mb-6 p-4 bg-black rounded shadow">
                                            ...
                                            <li class="flex justify-between my-3">
                                                ...
                                                <div class="flex justify-end items-center">
                                                    ...
                                                    <form method="POST" action="{{ route('shop.add-to-cart') }}">
                                                        ...
                                                        <button type="submit"
                                                                class="btn px-4 py-2 rounded-md bg-green-500 hover:bg-green-700 transition-colors duration-300 cursor-pointer"
                                                        >
                                                            Add to Cart
                                                        </button>
                                                    </form>
                            ...
                            <div class="mt-8 border-t pt-6">
                                ...
                                @auth('customer')
                                    ...
                                    @if (in_array($product->id, $customerReviewedProductIds))
                                        <p class="text-sm text-yellow-400 mb-6">You have already reviewed this product.</p>
                                    @else
                                        ...
                                        <div class="bg-black p-6 rounded-xl shadow">
                                            ...
                                            <form wire:submit.prevent="submitReview({{ $product->id }})" class="space-y-4">
                                                {{-- Rating stars --}}
                                                <div>
                                ...
                                @else
                                    <p class="text-sm text-gray-400">
                                        <a href="{{ route('shop.customer-login') }}" class="underline text-blue-500">Log in</a> to leave a
                                        review or reply.
                                    </p>
                                @endauth
                                    ...
                                    @forelse ($product->reviews as $review)
                                        <div class="border-b py-4">
                                            ...
                                            <button wire:click="toggleReplies({{ $review->id }})"
                                                    class="text-blue-500 underline mt-2 cursor-pointer">
