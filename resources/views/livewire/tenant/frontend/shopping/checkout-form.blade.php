<div class="max-w-lg mx-auto p-4 bg-black rounded shadow">
    ...
    <form wire:submit.prevent="submit" novalidate>
        ...
        <div class="mb-4">
            ...
            <input wire:model.lazy="address_line1" type="text" id="address_line1" class="w-full border rounded px-3 py-2" />
        ...
        <div class="mb-4">
            ...
            <input wire:model.lazy="address_line2" type="text" id="address_line2" class="w-full border rounded px-3 py-2" />
