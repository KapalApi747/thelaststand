...
<div class="md:fixed md:w-full md:top-0 md:z-20 flex flex-row flex-wrap items-center bg-white p-6 border-b border-gray-300">
    ...
    <div class="flex-none w-56 flex flex-row items-center">
        <img src="{{ 'http://placehold.co/40x40' }}" class="w-10 flex-none" alt="logo">
        <div class="flex flex-col flex-1 ml-3">
            <strong class="capitalize">The Last Stand</strong>
            <a href="{{ route('home') }}" class="text-xs text-gray-600 hover:text-gray-900 transition-colors ease-in-out duration-500">Return to Home</a>
        </div>
        ...
        <div class="flex flex-row-reverse items-center">
            ...
            <div class="dropdown relative md:static">
                ...
                <button class="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
                    @php
                        $user = auth()->user();
                        $profilePicturePath = 'https://placehold.co/40x40?text=No+Image';
                    @endphp
                    ...
                    <div class="ml-2 capitalize flex ">
                        <h1 class="text-sm text-gray-800 font-semibold m-0 p-0 leading-none">{{ auth('central')->user()->name ?? 'WTF HACKER' }}</h1>
