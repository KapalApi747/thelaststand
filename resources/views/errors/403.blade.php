...
<div class="max-w-5xl mx-auto bg-gray-900 p-10 rounded-xl shadow-lg border border-gray-800 text-center">
    ...
    <p class="text-xl mt-4 font-semibold">Store Inactive</p>
    <p class="mt-2 text-gray-400">This store is currently inactive. Please check back later or contact the administrator if you believe this is an error.</p>
